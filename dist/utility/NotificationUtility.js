...
var onRequestOTP = function (otp, toPhoneNumber) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                accountSid = "ACa029a5d69c0121babe179aae7c0ef807";
                authToken = "95afcf8caf32437abfdd8f60e760816b";
                client = require("twilio")(accountSid, authToken);
                return [4 /*yield*/, client.message.create({
                        body: "Your OTP is ".concat(otp),
                        from: "+15075954479",
                        to: "+234".concat(toPhoneNumber), // recipient phone number // Add country before the number
                    })];
            case 1:
                response = _a.sent();
